...
<tr>
 <td>
   <a href="acrobat-sign.md#tutorial1">
      <img alt="起始Acrobat共用稽核" src="../assets/acrobat_sharedreview_armstrong.jpg" />
   </a>
    <div>
  ...
  <td>
    <a href="acrobat-sign.md#tutorial2">
        <img alt="使用Adobe Sign建立線上劐免Forms" src="../assets/sign_webforms_palmer-kobey_thumbnail.jpg" />
    </a>
    <div>
  ...
  <td>
   <a href="acrobat-sign.md#tutorial3">
      <img alt="向Adobe Sign要求簽名" src="../assets/sign_request-signature_borstein_thumbnail.jpg" />
   </a>
    <div>
...
<tr>
 <td>
   <a href="acrobat-sign.md#tutorial4">
      <img alt="以液態模式檢視行動裝置上的功能表" src="../assets/acrobat_liquidmode_enke_thumbnail.jpg" />
   </a>
    <div>
  ...
  <td>
    <a href="acrobat-sign.md#tutorial5">
        <img alt="從行動電話掃描檔案至PDF" src="../assets/acrobat_scan_enke.jpg" />
    </a>
    <div>
