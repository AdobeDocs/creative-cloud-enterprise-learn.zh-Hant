---
title: XD
description: Adobe XD是使用者體驗設計和原型工具，用於設計網站、應用程式、語音介面、遊戲和其他型別的數位體驗
feature: UI Design
role: User
...
<tr>
 <td>
   <a href="xd.md#tutorial1">
      <img alt="建立具有暫留狀態的元件" src="../assets/Xd_hoverstates_components_thumbnail.jpg" />
   </a>
    <div>
  ...
  <td>
   <a href="xd.md#tutorial3">
      <img alt="使用棧疊" src="../assets/xd_Stacks_thumbnail.jpg" />
   </a>
    <div>
...
<tr>
 <td>
    <a href="xd.md#tutorial7">
        <img alt="電子郵件 — 使用棧疊" src="../assets/xd_stacks_torres.jpg" />
    </a>
    <div>
