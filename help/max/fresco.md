---
title: Fresco
description: Adobe Fresco是一款跨平台應用程式，可結合向量和點陣工作流程與雲端檔案，使用筆刷式方法來建立繪圖與繪畫
...
<tr>
 <td>
   <a href="fresco.md#tutorial1">
      <img alt="使用Adobe Fresco繪圖簡介" src="../assets/fresco_drawingPaintingIntro_tanonis_thumbnail.jpg" />
   </a>
    <div>
  ...
  <td>
   <a href="fresco.md#tutorial2">
      <img alt="建立紋理圖稿 — Fresco至Illustrator" src="../assets/fresco_textureToVector_tanonis_thumbnail.jpg" />
   </a>
    <div>
...
[學習與支援](https://helpx.adobe.com/tw/support/adobe-fresco.html)是您其他教學課程、[新增功能](https://helpx.adobe.com/tw/fresco/using/whats-new.html)和社群論壇連結的中樞。
