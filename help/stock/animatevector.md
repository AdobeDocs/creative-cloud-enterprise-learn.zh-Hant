---
title: 在Photoshop中將Adobe [!DNL Stock] 向量插圖製作成動畫
description: 使用Adobe [!DNL Stock]的可編輯向量將動畫帶入您的電子報圖形
...
# 在Photoshop中將Adobe [!DNL Stock]向量插圖製作成動畫

使用Adobe [!DNL Stock]的可編輯向量，將動畫帶入您的電子報圖形中。
