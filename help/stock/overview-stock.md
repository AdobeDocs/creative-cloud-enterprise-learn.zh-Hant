...
<tr>
   ...
   <a href="assets/CreateacompositewithPhotoshopontheiPadandAdobeStockimages.pdf">
    ...
    <div>
   <a href="assets/CreateacompositewithPhotoshopontheiPadandAdobeStockimages.pdf"><strong>在 iPad 上使用 Photoshop 建立複合影像，並Adobe [!DNL Stock] 影像 （PDF）</strong></a>
    </div>
   ...
   <a href="assets/CreateaUniqueEditorialGraphicwithAfterEffectsandAdobeStock.pdf">
    ...
    <div>
   <a href="assets/CreateaUniqueEditorialGraphicwithAfterEffectsandAdobeStock.pdf"><strong>在 Photoshop （PDF） 中Animate [!DNL Stock] Adobe向量插圖</strong></a>
    </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/CreateUniqueGraphicsbyCombiningAdobeStockImages.pdf"><strong>合併Adobe [!DNL Stock] 影像來建立獨特的圖形 （PDF）</strong></a>
      </div>
...
<tr>
   <td>
      ...
      <div>
      <a href="assets/CreatingaHalloweenCinemagraphwithPhotoshopCCandAdobeStock.pdf"><strong>使用 Photoshop CC 和 Adobe （PDF） 建立一個格點 [!DNL Stock] 電影</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/PutyourDatainMotionwithAdobeStockandPremierePro.pdf"><strong>使用 Adobe 和 Premiere Pro [!DNL Stock] （PDF） 讓資料動起來</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/RecolorAdobeStockVectorArtworkwithAdobeIllustratortoGetExactlytheLookYouWant.pdf"><strong>使用Adobe Illustrator重新上色Adobe [!DNL Stock] 向量圖稿，以獲得您想要的外觀 （PDF）</strong></a>
      </div>
 ...
 <tr>
   <td>
      ...
      <div>
      <a href="assets/ShowOffyourDesignWorkintheRealWorldwithAdobeStockandPhotoshop.pdf"><strong>使用 Adobe 和 Photoshop [!DNL Stock] （PDF） 在真實世界中展現您的設計作品</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/UncoveramazingdetailsinAdobeStockimageswithLightroomformobile.pdf"><strong>使用Lightroom 行動版 （PDF） 發掘Adobe [!DNL Stock] 影像的驚人細節</strong></a>
      </div>
   ...
   <td>
      ...
      <div>
      <a href="assets/VisualizePosterDesignsintheRealWorldwithAdobeStockandPhotoshop.pdf"><strong>使用Adobe和Photoshop [!DNL Stock] （PDF） 在真實世界中視覺化海報設計</strong></a>
      </div>
