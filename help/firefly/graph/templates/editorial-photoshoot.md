---
title: 編輯拍照
description: 瞭解如何輸入模型參考並為每個新外觀交換服裝輸入
...
瞭解如何輸入模型參考並為每個新外觀交換服裝輸入。 姿勢和光源節點會持續鎖定在集內，以維持一致的編輯感覺。 [開啟編輯攝影範本](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:cfd7b810-2f86-5cdf-af80-dd2e31b8b84b)。
