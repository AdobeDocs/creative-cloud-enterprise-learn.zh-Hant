---
title: 分鏡指令碼產生器
description: 瞭解如何使用文字提示將您的想法自動轉換為分鏡指令碼
...
瞭解如何使用文字提示將您的想法自動轉換為分鏡指令碼。 依場景建立場景，為敘述的每一個節拍新增一個節點。 重新排序節點以測試不同的序列，然後再鎖定最終的面板順序。 [開啟分鏡指令碼產生器範本](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:962af654-f338-58eb-ac9a-3ce151c2f4bc)。
