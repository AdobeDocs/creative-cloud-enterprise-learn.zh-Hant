---
title: 設計系統產生器
description: 瞭解如何根據網站熒幕擷圖產生設計系統
...
瞭解如何根據網站熒幕擷圖產生設計系統。 圖形會在單一批次執行中產生一組相符的圖示、圖樣和版面配置元件。 [開啟設計系統產生器](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:b40cd34c-66b2-586c-ab4a-5595490cded6)。
