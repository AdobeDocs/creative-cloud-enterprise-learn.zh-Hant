...
# Adobe [!DNL Firefly Graph]總覽

如果您以前使用創作AI工具，您可能會習慣輸入提示、獲得一個結果，並在下次您需要類似工具時從頭開始。 Firefly Graph的運作方式不同。 您會建立圖形，而不是單一提示：視覺化的逐步工作流程，其中每個輸入、轉換和輸出都會連線並儲存在一起。

>[!TIP]
>
>把它想像成一個菜譜，而不是一頓飯。 建立圖表後，您可以將其關閉、在新的輸入上重新執行，或變更一個步驟並讓所有下游自動更新。

此頁面會逐步引導您瞭解建立第一個圖表所需的一切：核心概念、逐步第一個工作流程，以及可立即開啟和調整之現成範本的資料庫。
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-graph/what-is-firefly-graph" target="_blank" rel="referrer" title="什麼是Firefly Graph？">什麼是Firefly Graph？</a>
                    </p>
                    <p class="is-size-6">瞭解圖表與單一提示的比較情形，以及讓每個步驟可見且可重複使用的原因</p>
                </div>
                <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-graph/what-is-firefly-graph" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">閱讀教學課程</span>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Firefly Graph Key Concepts">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-graph/key-concepts" target="_blank" rel="referrer" title="Firefly Graph重要概念">Firefly Graph重要概念</a>
                    </p>
                    <p class="is-size-6">涵蓋Firefly Graph心智模型的四個概念 — 節點、連線、工作流程和範本</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create your First Graph">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-graph/create-your-first-graph" target="_blank" rel="referrer" title="建立您的第一個圖表">建立您的第一個圖表</a>
                    </p>
                    <p class="is-size-6">建置第一個Firefly Graph工作流程（從空白畫布到匯出）的逐步解說</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Customize a Template">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-graph/customize-template" target="_blank" rel="referrer" title="自訂範本">自訂範本</a>
                    </p>
                    <p class="is-size-6">將Firefly Graph範本轉換為可反映您個人簡介和資產的工作流程的簡短檢查清單</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Firefly Graph Template Library">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-graph/template-library" target="_blank" rel="referrer" title="Firefly圖表範本程式庫">Firefly圖表範本資料庫</a>
                    </p>
                    <p class="is-size-6">瀏覽現成的Firefly Graph範本，以讓您開啟並適應自己的專案</p>
                </div>
